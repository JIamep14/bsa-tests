...
class remindTakenBook extends Job implements ShouldQueue
{
    ...
    public function handle(Mailer $mailer)
    {
        ...
        // все таки я должен был сделать отдельную таблицу для отношений user<->book, если бы так сделал, то можно было бы передавать в job user<->book запись или ее id и потом проверять, существует ли она.
