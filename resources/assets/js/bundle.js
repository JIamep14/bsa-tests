...
},{"./BookModel.js":11,"backbone":4}],13:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./app.js":7,"backbone.marionette":2}],18:[function(require,module,exports){
var Marionette = require('backbone.marionette');
_ = require('underscore');
var $ = require('jquery');
app = require('../app.js');
...
module.exports = Marionette.ItemView.extend({
    template: window['JST']['loading.tpl']
});

},{"backbone.marionette":2}],20:[function(require,module,exports){
_ = require('underscore');
var Marionette = require('backbone.marionette');
